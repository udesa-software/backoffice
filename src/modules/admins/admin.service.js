...
// Genera una contraseña temporal legible (ej: "Ax7k-9mPq")
...
const adminService = {
  ...
  async createAdmin({ email, role }, createdById) {
    ...
    // Enviar email con contraseña temporal (fire-and-forget)
    ...
    return {
      ...admin,
      temp_password: tempPassword, // devolver en respuesta para que el SuperAdmin la vea
  ...
  async resetAdminPassword(targetAdminId, requestingAdminId) {
    ...
    // No se puede resetear la propia contraseña con este endpoint
