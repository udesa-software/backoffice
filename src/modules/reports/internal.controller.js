...
const internalReportsController = {
  ...
  async receiveReport(req, res, next) {
    try {
      const { reporterId, reporterUsername, reportedId, reportedUsername, reason, createdAt } = req.body;
      ...
      await query(
        `INSERT INTO user_reports (reporter_id, reporter_username, reported_id, reported_username, reason, reported_at)
         VALUES ($1, $2, $3, $4, $5, $6)`,
        [reporterId, reporterUsername, reportedId, reportedUsername, reason, createdAt ?? new Date()]
      );
